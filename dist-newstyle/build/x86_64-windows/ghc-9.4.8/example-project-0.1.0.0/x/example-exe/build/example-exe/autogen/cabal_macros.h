...
/* package example-project-0.1.0.0 */
#ifndef VERSION_example_project
#define VERSION_example_project "0.1.0.0"
#endif /* VERSION_example_project */
#ifndef MIN_VERSION_example_project
#define MIN_VERSION_example_project(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_example_project */
...
#define CURRENT_COMPONENT_ID "example-project-0.1.0.0-inplace-example-exe"
